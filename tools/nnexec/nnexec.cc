...
{
  return static_cast<void*>(new NeuralNetwork(ptr_nnData, nnDataLen,
      tensorArenaSize));
}
...
{
  static_cast<NeuralNetwork*>(ptr_nn)->setInputData(inputLayerIdx,
      ptr_inputData, inputDataLen);
}
...
{
  static_cast<NeuralNetwork*>(ptr_nn)->getOutputData(outputLayerIdx,
      ptr_outputData, outputDataLen);
}

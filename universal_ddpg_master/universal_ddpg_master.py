...
master = Master(
    ...
    b_offline_training_only=config["master_config"]["b_offline_training_only"],
)
...
if config["master_config"]["doc"] != "":
    doc_file_name = os.path.join(master.get_output_dir(), "Documentation.txt")

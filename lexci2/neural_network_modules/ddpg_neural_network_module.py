"""This file contains a helper class for interacting with a DDPG agent's neural
...
File:   lexci2/neural_network_modules/ddpg_neural_network_module.py
...
class DdpgNeuralNetworkModule(NeuralNetworkModule):
        ...
        Arguments:
            ...
            - kwargs
                  ...
                  - tensor_arena_size: int (Default: 1000000, Unit: B)
                    Size of the tensor arena. This argument is ignored if the
                    neural network data format is "keras".
    ...
    def get_norm_action(
        ...
        """Get a normalized action for a given normalized observation.
        ...
        Arguments:
            ...
            - kwargs
                  ...
                  - "stdev": float (Default: 1)
                      Standard deviation to use for sampling from a Gaussian
                      distribution.
        ...
        norm_action = norm_action_dist
        if b_sample:
            norm_action += np.random.normal(size=norm_action_dist.shape) * stdev
    ...
    def normalize_action_dist(self, action_dist: np.ndarray) -> np.ndarray:
        ...
        return self.normalize_action(action_dist)
    ...
    def denormalize_action_dist(
        ...
        return self.denormalize_action(norm_action_dist)
